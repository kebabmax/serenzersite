...
- **Second oubli trouvé lors d'une contre-vérification du rapport final** : 5 langues supplémentaires (PT, DA, SV, NO, PL) avaient elles aussi échappé à la resynchronisation `dual_card1`/`dual_card2` (mêmes symptômes : titres/tags corrigés mais descriptions encore sur l'ancien contenu). Corrigé et vérifié une seconde fois de façon exhaustive sur les 19 langues.
